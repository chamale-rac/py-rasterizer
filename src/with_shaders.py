...
rock.set_shaders(shaders.vertex_shader, shaders.invert_shader)
...
land.set_shaders(shaders.vertex_shader, shaders.fractal_shader)
land_small.set_shaders(shaders.vertex_shader, shaders.fractal_shader)
...
sarcofago.set_shaders(shaders.vertex_shader,
                      shaders.camouflage_shader)


close_tables.load_texture(f"../last/textures/tables.bmp")
far_tables.load_texture(f"../last/textures/tables.bmp")
close_tables.set_shaders(shaders.vertex_shader, shaders.camouflage_shader)
far_tables.set_shaders(shaders.vertex_shader, shaders.camouflage_shader)

tree = Model(f"../last/objs/tree.obj",
             translate=(0, 0, -8), scale=(1, 1, 1), rotate=(0, 0, 0))
tree.load_texture(f"../last/textures/tree_dark.bmp")
tree.set_shaders(shaders.vertex_shader, shaders.invert_shader)

home = Model(f"../last/objs/home.obj",
             translate=(0, 0, -8), scale=(1, 1, 1), rotate=(0, 0, 0))
home.load_texture(f"../last/textures/casita_dark.bmp")
home.set_shaders(shaders.vertex_shader, shaders.invert_shader)
...
renderer.gl_background_texture(f"../last/backgrounds/sky_bw.bmp")
...
renderer.gl_render()
renderer.gl_finish(
    f"{out_dir}/with_shaders{str(start_time).split('.')[0]}.bmp")
